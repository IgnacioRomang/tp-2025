...
public class UserControllerTest {
    ...
    public void testCrearUsuarioPropietario() throws Exception {
        // Arrange
        CuentaBancariaRecord cuentaBancariaRecord = new CuentaBancariaRecord(
            "123456789", 
            "1230001230001230001234", 
            "john.doe.mp",
            1
        );
        PropietarioRecord propietarioRecord = new PropietarioRecord(
            "John Doe", "john.doe@example.com", "1234567890", "12345678",
            null, cuentaBancariaRecord
        );
